...
public class TabulatedFunctionOperationServiceTest {
    ...
    public void exceptionsTest() {
        ...
        assertThrows(InconsistentFunctionsException.class, () -> new TabulatedFunctionOperationService().multiply(functionErr, functionListTest));
        ...
        assertThrows(InconsistentFunctionsException.class, () -> new TabulatedFunctionOperationService().divide(functionListTest, functionErr1));
